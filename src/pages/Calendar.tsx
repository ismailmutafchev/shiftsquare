...
export default function Calendar() {
    ...
    const startTimeStr = "October 13, 2014 08:00:00"
    const finishTimeStr = "October 13, 2014 16:30:00"
            ...
            <div className="flex h-full flex-col">
                ...
                <div className="isolate flex flex-auto overflow-y-scroll bg-white h-[65vh]">
                    <div ref={container} className="flex flex-auto flex-col overflow-auto">
                        ...
                        <div className="flex w-full flex-auto border">
                            <div className="w-14 flex-none bg-white ring-1 ring-gray-100" />
                            <div className="grid flex-auto grid-cols-3 grid-rows-1 w-10">
                                {/* Horizontal lines */}
                                <div
                                ...
                                {/* Events */}
                                <ol
                                    className="col-start-1 col-end-2 row-start-1 grid grid-cols-12"
                                    style={{
                                        gridTemplateRows: '1.75rem repeat(288, minmax(0, 1fr)) auto',
                                        gridTemplateColumns: 'repeat(12, minmax(0, 1fr))',
                                    }}
                                >
                                    <li className="relative mt-px flex" style={{ gridRow: `${startNumber} / span ${endNumber}` }}>
                                    </li >
                                    <li className="relative mt-px flex" style={{ gridRow: `${startNumber} / span ${endNumber}` }}>
                                        <a
                                            href="#"
                                        ...
                                        >
                                            {/* <p className="h-48 line-clamp-1 flex items-center justify-center order-1 font-semibold text-blue-700 -rotate-90">Elwira fdfdfdfdfdfdfdfdfdfd</p> */}
                                        </a>
                                    </li>
                                </ol >
                            </div >
