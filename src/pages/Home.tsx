import { AnimationSize, EasyAnimation, FinanceAnimation, OptimiseAnimation, PuzzleAnimation, ScheduleClock, ShiftBuild } from "../assets/AnimationComponents/AnimationComponents";
